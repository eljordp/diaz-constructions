      ...
      <section className="bg-navy-950 pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 bg-accent hover:bg-accent-light text-navy-950 font-semibold tracking-wide rounded transition-colors duration-200"
            >
              Get a Free Quote
      ...
      <section className="py-20 sm:py-28 bg-navy-950">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="tel:6504549122"
              className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 border-2 border-white/20 text-white font-semibold tracking-wide rounded hover:border-white/40 transition-colors duration-200"
            >
